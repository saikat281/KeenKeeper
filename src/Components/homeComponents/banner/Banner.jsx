        ...
        <div className='  pt-30'>
            <div className='container mx-auto p-10 space-y-6'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                    <div className='bg-green-50 w-full rounded-lg flex flex-col justify-center items-center px-10 py-7 text-center'>
                        <h1 className='text-3xl text-green-900 font-semibold'>8</h1>
                        <p className='text-gray-700 text-2xl'>Total Friends</p>
                    </div>
                    <div className='bg-green-50 w-full h-[200px] rounded-lg flex flex-col justify-center items-center px-10 py-7 text-center'>
                        <h1 className='text-3xl text-green-900 font-semibold'>3</h1>
                        <p className='text-gray-700 text-2xl'>On Track</p>
                    </div>
                    <div className='bg-green-50 w-full h-[200px] rounded-lg flex flex-col justify-center items-center px-10 py-7 text-center'>
                        <h1 className='text-3xl text-green-900 font-semibold'>4</h1>
